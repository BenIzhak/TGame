...
public class Monster extends Creature {
	...
	private long attackSpeed = 10; // Every "attackSpeed" frames try to attack. 60 mean try to attack every second.
	private long attackTimeCounter; // when this var is equal to attackSpeed try to attack.
